...
namespace AppLab5
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            //Grab data from user selections
            string product = "";
            string qty = "";
            string selectedDate = "";
            string selectedTime = "";
            ...
            await Navigation.PushAsync(new NavigationPage2(product, qty, selectedDate, selectedTime));
            ...
            ToolbarItems.Add(new ToolbarItem
            {
                ...
                Command = new Command(() =>
                Navigation.PushAsync(new NavigationPage2(product, qty, selectedDate, selectedTime)))
            });
            ToolbarItems.Add(new ToolbarItem
            {
                Text = "Invoice",
                Order = ToolbarItemOrder.Secondary,
                Command = new Command(() =>
                Navigation.PushAsync(new NavigationPage3(product, qty, selectedDate, selectedTime)))
            });
            ...
            List<Group> itemsGrouped = new List<Group>
                {
                    ...
                    {
                        new ListItem {Title = "Furniture", Description="1st item", Price="$200.00"},
            ...
            Label selectedProduct = new Label
            {
                HorizontalOptions = LayoutOptions.CenterAndExpand,
                FontSize = 24
            };
            ...
            {
                selectedDate = datePicker1.Date.ToString();
            };
            ...
            {
                selectedTime = timePicker1.Time.ToString();
            };
            ...
            ProductData.Date = selectedDate;
            ProductData.Time = selectedTime;

            submit.Clicked += (sender, args) =>
            {

                if (selectedProduct.Text == null)
                {
                    DisplayAlert("Alert", "Please select a product.", "OK");
                }

                else if (stepper.Value.Equals(null) || stepper.Value.Equals(0))
                {
                ...
                {
                    //var passData = new NavigationPage3(product, qty, selectedDate, selectedTime);
                    Navigation.PushAsync(new NavigationPage3(product, qty, selectedDate, selectedTime));
                }
            ...
            StackLayout navigationItems = new StackLayout()
            {
            ...
            {
                Children = { navigationItems, listView, dataView }
            };
            ...
            listView.ItemTapped += async (sender, e) =>
            {
                ...
                selectedProduct.Text = item.Title.ToString();
                product = item.Title.ToString();
