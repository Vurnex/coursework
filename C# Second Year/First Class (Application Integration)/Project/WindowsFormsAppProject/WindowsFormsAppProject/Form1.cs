...
namespace WindowsFormsAppProject
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //string neweggResults = JsonConvert.SerializeObject(MyClient.ScrapeNeweggData(), Formatting.Indented);

            //richTextBox1.Text = "Check DB";
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //JObject convEbayResults = JObject.Parse(ebayResults);
    ...
    /*             richTextBox1.Text = "";
            ...
            var html = @"https://www.newegg.com/Cell-Phones-Unlocked/SubCategory/ID-2961?Tid=167543&RandomID=170396951183120221213171744";
            ...
            foreach (var item in prices)
            {
                ...
                NeweggItems titleItems = new NeweggItems();

                titleItems.itemTitle = titles[count].InnerText;
                titleItems.itemPrice = prices[count].InnerText;

                neweggItems.Add(titleItems);

                count++;

            }

            string neweggResults = JsonConvert.SerializeObject(neweggItems, Formatting.Indented);
