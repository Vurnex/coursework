...
/* Modified all system() functions to "cls" for Visual Studio */
...
int main()
{
	system("cls");	//for clearing the console to make things neater, but for visual studio it is "cls" instead of "clear"
...
void resultsFile(FILE *inFile)
{
	...
	inFile = fopen("results.txt", "r");		//opens the file for reading
