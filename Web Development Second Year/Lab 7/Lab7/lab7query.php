...
<html>
    ...
    <body>
        <div id="container">
                ...
                <tbody>
                    ...
                    <?php while ($row = $q->fetch()): ?>
                        ...
                        <tr>
                            ...
                            <td class="Ages"><?php echo htmlspecialchars($row['Age']); ?></td>
            ...
            <form method="POST" action="lab7query2.php">
                <input type="submit" value="Ages < 23" id="button1"/>
            </form>

            <form method="POST" action="lab7query3.php">
                <input type="submit" value="Ages > 21"/>
            </form> 
    </body>
        </div>
