...
if (!isset($_SESSION['username'])) {
    ...
    echo "Please log in first. Redirecting.";
...
if ($_SESSION['username'] != "admin") {
    ...
    echo "Unauthorized. Redirecting.";

    header('Refresh: 2; URL = problem3userhome.php');
...
<html>
    ...
    <head>
        ...
        <title>ITS-362 Final Exam Problem 3</title>
                ...
                <tbody>
                    ...
                    <?php while ($row = $q->fetch()): ?>
                        ...
                        <tr>
                            ...
                            <td><a href="<?= 'http://localhost/delete.php?id=' . $row['StudentID'] ?>" onclick="return confirm('Are you sure you want to delete this record?')">Delete</a></td>
                        </tr>
